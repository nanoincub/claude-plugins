...
>
> **Após recepção:** ❌ → implementer corrige → re-review. ✅ → despachar [code-quality-reviewer-prompt.md](code-quality-reviewer-prompt.md). Aplicar [receiving-feedback.md](../nano-disciplines:skills/code-review/references/receiving-feedback.md).
