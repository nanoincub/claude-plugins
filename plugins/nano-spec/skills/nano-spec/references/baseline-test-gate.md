...
Agente NÃO roda os testes diretamente — pede ao dev e aguarda confirmação do resultado. Motivo: evita gasto de tokens em output de centenas de testes. `superpowers:verification-before-completion` valida a confirmação.
